// src/app/hazards/create/page.tsx
'use client';
...
export default function CreateHazardPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || 'فشل في إنشاء الخطر');
      }

      setMessage('تم إنشاء الخطر بنجاح');
      ...
      setError(error.message || 'حدث خطأ أثناء إنشاء الخطر');
    } finally {
      setIsSubmitting(false);
    }
  };
